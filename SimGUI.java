...
class SimGUI {
	...
	public void genGraph() {
		...
		if (alg.graphEdgeType() == EdgeType.DIRECTED) {
			 ...
			 * uncomment.
			 * 
			 * ErdosRenyiGenerator<ThreeTenNode, ThreeTenEdge> gen = new
			 * ErdosRenyiGenerator<>( ThreeTenGraph.<ThreeTenNode,ThreeTenEdge>getFactory(),
			 * nodeFactory, edgeFactory, this.numNodes,this.prob );
			 * gen.setSeed(this.r.nextInt()); g = gen.create();
			 */
		}
	}
